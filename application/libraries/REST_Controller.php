...
abstract class REST_Controller extends CI_Controller {
    ...
    public function response($data = NULL, $http_code = NULL, $continue = FALSE)
    {
		...
		//$this->output->set_header('Access-Control-Allow-Headers: DNT,X-Mx-ReqToken,Keep-Alive,User-Agent,X-Requested-With,If-Modified-Since,Cache-Control,Content-Type');
